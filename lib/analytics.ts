 ...
 * that require prior opt-in for analytics cookies, in case visitors arrive
 * from there. Everywhere else defaults to granted, which is the accepted
 * posture in NZ and AU (notification regimes, not prior-consent ones) - and
 * NZ is the core market, so it deliberately is not in the denial list.
 */
