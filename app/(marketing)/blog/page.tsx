...
export const metadata = buildMetadata({
  title: "Blog",
  description:
    "Field notes from the benchtop industry: quoting, pricing, production flow and the software that holds a fabrication business together.",
  path: "/blog",
});
      ...
      <section className="surface-cream pb-12 pt-28 sm:pt-32 md:pb-16 lg:pt-36">
        <Container>
          ...
          <h1 className="mt-5 display-hero max-w-3xl text-balance">
            Field notes from the factory office
          </h1>
          <p
            className="mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground"
            data-speakable
          >
            Practical writing on running a benchtop business - quoting,
            pricing, production flow, and the places jobs go sideways between
            the enquiry and the install.
          </p>
        </Container>
      </section>
