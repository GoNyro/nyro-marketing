  ...
  return (
    <MotionProvider>
      <SmoothScroll>
        ...
        <Footer />
        {/* Column rules at the content edges, carried through every section.
            Painted last so they sit over section backgrounds; inert to
            pointers and screen readers. Low-contrast gray reads as a hairline
            on light surfaces and a whisper on ink. */}
        <div
          aria-hidden
          className="pointer-events-none fixed inset-y-0 left-1/2 hidden w-full max-w-6xl -translate-x-1/2 border-x border-[oklch(0.5_0.005_145/0.14)] xl:block"
        />
      </SmoothScroll>
    </MotionProvider>
  );
