...
type CtaBandProps = {
  ...
  sub?: string;
  /** Secondary action link. Pass null to hide. */
...
export function CtaBand({
  ...
  title = (
    <>
      Put quoting in your
      <br className="hidden sm:block" /> customers&apos; hands.
    </>
  ),
  sub = "Book a 30-minute walkthrough. We'll set up a sample catalog and show you what your customers would see - drawing a benchtop and watching it price itself.",
  secondary = { label: "See the Customer Portal", href: "/customer" },
  className,
}: CtaBandProps) {
  return (
    <section className={cn("surface-dark relative overflow-hidden", className)}>
      <div
        ...
        style={{
          background:
            "radial-gradient(40rem 22rem at 50% -10%, oklch(0.58 0.1 132 / 0.35), transparent 70%)",
        }}
      />
